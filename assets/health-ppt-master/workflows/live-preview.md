...
```bash
python3 <skill-dir>/scripts/svg_editor/server.py <project_path>
```
...
1. Discover annotations:
   ```bash
   python3 <skill-dir>/scripts/check_annotations.py <project_path>
   ```
...
```bash
python3 <skill-dir>/scripts/svg_editor/server.py <project_path> --no-browser
