...
kind: layout
summary: Clinical case reports & case discussions, teaching rounds, CME courses, and general hospital / medical-university decks.
...
> Suitable for clinical case reports / discussions, teaching rounds, CME courses, and general hospital & medical-university decks. For research result reporting / journal club use `medical_research`; for grant proposals / accreditation / formal applications use `medical_official`.
...
| **Use Cases**    | Clinical case reports & discussions, teaching rounds, CME courses, general hospital decks |
