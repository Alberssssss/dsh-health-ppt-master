import { t as ROUTER_HINT } from "./router-DUN68r2i.js";
//#region lib/types/invariant.js
/** Package-owned router-message invariant. @module @deepseek-ai/dsh-experimental-health-ppt-master/invariant */
const PACKAGE_NAME = "@deepseek-ai/dsh-experimental-health-ppt-master";
/** Cordis companion plugin name. */
const name = "health-ppt-master-invariant";
/** Service required before the companion can reserve package ownership. */
const inject = ["invariants"];
function validateEvent(event, fail) {
	if (event.type !== "user/message" || event.data.source.kind !== "plugin" || event.data.source.plugin !== "health-ppt-master") return;
